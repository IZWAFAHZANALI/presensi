...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center mb-4">
        <a href="<?= base_url('Pegawai/home') ?>" class="btn btn-white shadow-sm btn-sm me-3" style="border-radius: 10px; padding: 8px 15px;">
    ...
    <div class="card shadow-sm border-0 overflow-hidden" style="border-radius: 15px;">
        <div class="row g-0">
            <div class="col-md-4 bg-light d-flex flex-column align-items-center justify-content-center py-5 border-end">
                ...
                <form action="<?= base_url('Pegawai/profile/update_foto/' . $pegawai['id']) ?>" method="post" enctype="multipart/form-data" id="formFoto">
                    <?= csrf_field(); ?>
                ...
                <div class="card-body p-4 p-lg-5">
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-sm-6">
                            ...
                            <div class="fw-bold text-dark p-3 bg-light input-disabled"><?= $pegawai['username'] ?></div>
                        </div>
                        <div class="col-sm-6">
                            <label class="small text-muted mb-1">Jenis Kelamin</label>
                            <div class="fw-bold text-dark p-3 bg-light input-disabled"><?= $pegawai['jenis_kelamin'] ?></div>
                        </div>
                        <div class="col-sm-6">
                            <label class="small text-muted mb-1">No. Handphone</label>
                            <div class="fw-bold text-dark p-3 bg-light input-disabled"><?= $pegawai['no_handphone'] ?></div>
                        </div>
                        <div class="col-sm-6">
                            <label class="small text-muted mb-1">Alamat</label>
                            <div class="fw-bold text-dark p-3 bg-light input-disabled"><?= $pegawai['alamat'] ?></div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        <div class="col-sm-6">
                            ...
                            <div class="d-flex align-items-center p-3 border input-disabled-dashed">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="p-3 border input-disabled-dashed">
